...
#    set(SGX_MODE Debug CACHE STRING "SGX build mode: Debug; PreRelease; Release.")
    ...
    if(SGX_MODE STREQUAL "Debug")
        if (SGX_MODE_DEBUG STREQUAL "2")
            set(SGX_COMMON_CFLAGS "${SGX_COMMON_CFLAGS} -O0 -g -DDEBUG -UNDEBUG -UEDEBUG")
        elseif(SGX_MODE_DEBUG STREQUAL "1")
            set(SGX_COMMON_CFLAGS "${SGX_COMMON_CFLAGS} -O0 -g -DDEBUG1 -UNDEBUG -UEDEBUG")
        else()
            set(SGX_COMMON_CFLAGS "${SGX_COMMON_CFLAGS} -O0 -g -DWARNING -UNDEBUG -UEDEBUG")
        endif()
